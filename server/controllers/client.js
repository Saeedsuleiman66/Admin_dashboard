...
//             {
//                 $lookup: {
//                     from: "Product", // Ensure this matches the collection name in MongoDB
...
//                 $unwind: {
//                     path: "$product",
//                     preserveNullAndEmptyArrays: true, // Keep products without stats
//                 },
//             },
//         ]);
...
const getCustomers = async (req, res) => {
	try {
		const customers = await User.find({ role: "user" }).select("-password"); //select all user except password
